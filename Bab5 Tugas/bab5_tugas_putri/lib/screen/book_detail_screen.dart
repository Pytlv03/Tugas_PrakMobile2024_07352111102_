    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Judul: ${widget.book.title}', style: TextStyle(fontSize: 18, color: Colors.purple)),
            SizedBox(height: 8),
            Text('Penulis: ${widget.book.author}', style: TextStyle(fontSize: 16, color: Colors.purple)),
            SizedBox(height: 8),
