      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              TextFormField(
                decoration: InputDecoration(labelText: 'Judul', labelStyle: TextStyle(color: Colors.purple)),
                onChanged: (value) {
                  setState(() {
                    title = value;
                  });
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'Penulis', labelStyle: TextStyle(color: Colors.purple)),
                onChanged: (value) {
                  setState(() {
                    author = value;
                  });
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'Deskripsi', labelStyle: TextStyle(color: Colors.purple)),
                onChanged: (value) {
                  setState(() {
                    description = value;
                  });
